namespace Fast_Food
{
	partial class Example
	{
		...
		private void InitializeComponent()
		{
			...
			this.dgvConsist.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle7;
			...
			this.dgvConsist.DefaultCellStyle = dataGridViewCellStyle8;
			...
			this.dgvMenu.DefaultCellStyle = dataGridViewCellStyle10;
			...
			this.dgvMenu.CellValidating += new System.Windows.Forms.DataGridViewCellValidatingEventHandler(this.dgvMenu_CellValidating);
